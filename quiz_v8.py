...
def ask_name():
    ...
    name = input("What is your name?(Minimum 3 letters): ")
...
def instructions():
    ...
    list_rules = input("(***Highly Recommended***) "
                       "\n\tWould you like a list of the Rules? 'Y' or 'N': ")
...
def input_for_quiz():
    ...
    guess = input("Which of these options will you choose? (A,B,C,D): ")
...
def play_again():
    ...
    ask_play = input("Would you like to play again? (Y or N): ")
    play_again_confirmed = str_checker(ask_play, "Would you like to"
                                       " play again? (Y or N): ").title()
